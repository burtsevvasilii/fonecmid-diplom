...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//Добавление новых профилей групп доступа
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "75a57fd9-6b76-4917-9dbb-8f6783ab2845";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "a6a26b10-0bce-460a-b290-a7b3825ff0aa";
	...
	ОписаниеПрофиля.Идентификатор = "7a9dcf47-1f73-4a38-8292-5d03766c6566";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОчетПоАнализуВыставленныхАктов");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Кадровик-расчетчик";
	ОписаниеПрофиля.Идентификатор = "2133c7a0-5e90-4262-bb43-6f4f6f9fa040";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВводИнформацииПоЗаработнойПлате");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтпусками");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетПоВыработкеСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетыЗарплатаИОтпуска");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
